    ...
    <div class="row container">
      ...
      <ul class="collection with-header">
        ...
        <li class="collection-item">
          <div><?php echo ($workSkill['skill_name']) ?><a href="javascript:void(0);" class="skill_del secondary-content red-text" data-id="<?php echo $workSkill['id'] ?>"><i class="fas fa-trash"></i></a></div>
        </li>
        <?php endforeach ?>
        ...
        <li class="collection-item">
          <form id='add_skill'>
            <div>
              ...
              <button class="btn waves-effect waves-light" type="submit">存檔
